...
import MockCameraScreen from '../screens/MockCameraScreen';
...
const ScreenRenderer: React.FC = () => {
  ...
  const renderScreen = () => {
    switch (currentScreen) {
      ...
      case 'MockCamera': case 'Camera': return <MockCameraScreen />;
  ...
  return (
    <div className="relative w-full max-w-md mx-auto h-full bg-white shadow-2xl overflow-hidden flex flex-col">
      <div className="relative flex-1 w-full overflow-hidden">{renderScreen()}</div>
      <BottomNav />
    </div>
  );
};
