...
export const ENV_EMOJI: Record<string, string> = {
  alley: '🏘️', parking: '🚗', park: '🌳', mountain: '⛰️',
  temple: '⛩️', arcade: '🏛️', market: '🥬', wall: '🧱',
  shop: '🏪', station: '🚉',
};

// 花色 emoji 對照
export const COLOR_EMOJI: Record<string, string> = {
  black_white: '🐄', orange: '🐈', white: '🥛', gray: '🐭',
  black: '🐈‍⬛', calico: '🐆', tortoiseshell: '🦕', tabby: '🐅',
  siamese: '💂', white_tabby: '🦓', orange_white: '🦊', brown_white: '🥐',
};

// 姿勢 emoji 對照
export const POSE_EMOJI: Record<string, string> = {
  basking: '☀️', curled_sleep: '🌙', walking: '🐾', grooming: '🛁',
  alert_standing: '👂', sitting: '🛋️', eating: '🍱',
};
